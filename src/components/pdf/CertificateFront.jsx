 ...
 * ✅ FIXED: URLs are now cleaned in pdfHelpers.js
 */
  ...
  return (
    <Page size={[242.65, 153]} style={styles.page}>
      ...
      <View style={styles.watermarkLayer}>
        <Image src={watermarkPath} style={styles.backgroundWatermark} />
      </View>
        ...
        <View style={styles.mainContent}>
          ...
          <View style={styles.leftSection}>
            ...
            <View style={styles.inspectorSection}>
              ...
              {/* ✅ FIXED: Use cleaned certifierSignatureUrl */}
              {data?.certifierSignatureUrl ? (
                <Image src={data.certifierSignatureUrl} style={styles.signatureImage} />
              ) : data?.signatureUrl ? (
          ...
          <View style={styles.centerSection}>
            <Text style={styles.certificationText}>
              This is to certify that this person has been tested in accordance
              with the requirements of ASME SEC IX (EDITION-2020)
            </Text>
          ...
          <View style={styles.rightSection}>
            ...
            <View style={styles.clientRepSection}>
              ...
              <Text style={styles.clientRepName}>
                {data?.clientRep || 'N/A'}
              </Text>
            </View>
          </View>
